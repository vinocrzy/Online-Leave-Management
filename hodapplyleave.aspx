<%@ Page Title="" Language="C#" MasterPageFile="~/AdminHome.master" AutoEventWireup="true" CodeFile="hodapplyleave.aspx.cs" Inherits="Default2"  %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%">
        <tr>
            <td colspan="2" style="background-color: #33ffff">
                <strong style="width: 100%">Apply For Leave:</strong></td>
        </tr>
        <tr>
            <td style="width: 25%">
                <img alt="" src="Images/man-leaving-office-door.jpg" 
                    style="height: 373px; width: 342px" /></td>
                    ...
                    <tr>
                        ...
                        <td style="width: 70%; text-align: left">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFrom"
                                Display="Dynamic" ErrorMessage="Please select Period From" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 40%; text-align: right">
                    ...
                    <tr>
                        ...
                        <td style="width: 70%; text-align: left">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtTo"
                                Display="Dynamic" ErrorMessage="Please select Period To" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 70%; height: 73px; text-align: left">
                            <asp:TextBox ID="txtpurpose" runat="server" Height="63px" TextMode="MultiLine" Width="185px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 40%; text-align: right">
                        ...
                        <td style="width: 70%; text-align: left">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtpurpose"
                                Display="Dynamic" ErrorMessage="Please select Purpose" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 40%; text-align: right">
                            Email:</td>
                        <td style="width: 70%; text-align: left">
                            <asp:TextBox ID="txtTo0" runat="server" Width="184px"></asp:TextBox>
