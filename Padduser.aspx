<%@ Page Title="" Language="C#" MasterPageFile="~/departmenthome.master" AutoEventWireup="true" CodeFile="Padduser.aspx.cs" Inherits="Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%">
        <tr>
            <td colspan="2" style="background-color: #33ffff; height: 37px;">
        ...
        <tr>
            ...
            <td style="width: 50%" bgcolor="#3399FF">
                <table style="width: 100%">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 50%">
                            <asp:TextBox ID="txtempid" runat="server" Width="146px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 50%">
                            <asp:TextBox ID="txtempname" runat="server" 
                                ontextchanged="txtempname_TextChanged" Width="147px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width: 50%; text-align: right">
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 50%; height: 26px;">
                            <asp:TextBox ID="txtadmission" runat="server" Width="144px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 50%">
                            <asp:TextBox ID="txtqual" runat="server" Width="142px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width: 50%; text-align: right">
                        </td>
