<%@ Page Language="C#" MasterPageFile="~/EmployeeHome.master" AutoEventWireup="true" CodeFile="updateemp.aspx.cs" Inherits="updateemp" Title="Online Leave Management" %>
                ...
                <table style="width: 100%" bgcolor="#6699FF">
                    ...
                    <tr>
                        <td style="width: 50%; text-align: right; height: 33px;">
                            Change password:</td>
                        <td style="width: 50%; height: 33px;">
                            <asp:TextBox ID="txtqual0" runat="server" TextMode="Password"></asp:TextBox></td>
                    </tr>
                    <tr>
