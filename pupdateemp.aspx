<%@ Page Title="" Language="C#" MasterPageFile="~/departmenthome.master" AutoEventWireup="true" CodeFile="pupdateemp.aspx.cs" Inherits="Default2" %>
            ...
            <td style="width: 50%">
                <table style="width: 100%" bgcolor="Silver">
                    <tr>
                        ...
                        <td style="width: 50%">
                            <asp:DropDownList ID="DropDownList3" runat="server" Width="151px" OnSelectedIndexChanged="ddldesig_SelectedIndexChanged" AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 50%; height: 25px;">
                            <asp:TextBox ID="txtempname" runat="server" Width="145px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; text-align: right;">
                    ...
                    <tr>
                        ...
                        <td style="width: 50%">
                            <asp:TextBox ID="txtdob" runat="server" Width="144px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 50%">
                            <asp:TextBox ID="txtadmission" runat="server" Width="142px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 50%">
                            <asp:TextBox ID="txtqual" runat="server" Width="141px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
